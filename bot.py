...
help2 = 'Only you need is to send me photo of QR-code in your receipt as an image file, not as a photo'
...
def answer_photo(bot, update):
    ...
    if len(photo) != 0:
        update.message.reply_text("Told you not to send me photo directly. Please, send it as a file")
